...
<body>
    ...
    <?php
        ...
        if(isset($_POST["loginSubmit"])){
            $queryUsername = $pdo->prepare("SELECT count(*) as numUsers from users where username = :userInput and password = :passwordInput");
            $queryUsername->bindParam(":userInput", $_POST["loginUsername"]);
            $queryUsername->bindParam(":passwordInput", $pwd);
